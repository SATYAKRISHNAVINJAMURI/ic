...
if __name__ == "__main__":
    ...
    print mean_square_error(im1,im2)
    print normalised_cross_relation(im1,im2)
    print average_difference(im1,im2)
    print maximal_difference(im1,im2)
    print laplace_mean_squar_error(im1,im2)
